            ...
            <div className="flex flex-col items-center justify-center min-h-screen text-white py-16 px-4">
                <div className="container mx-auto max-w-7xl">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                        <div className="bg-gray-900/30 p-6 rounded-xl border border-purple-700 backdrop-blur-sm">
                            ...
                            <Link
                                to="/buy-ticket"
                                className="inline-block px-4 py-2 bg-purple-600/80 hover:bg-purple-600 backdrop-blur-sm rounded-lg transition-colors"
                            >
                                Browse Tickets
                            </Link>
                        </div>
